...
public class CameraOrbit : MonoBehaviour {
    ...
    {   
            ...
            {
                if (Input.GetTouch(0).position.x/Screen.width < Camera.main.rect.width) {
                    ...
                    desiredDistance += deltaMagDiff * Time.deltaTime * zoomRate * 0.0075f * Mathf.Abs(desiredDistance);
                }
            }
